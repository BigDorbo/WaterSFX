...
namespace WaterSFX
{
    ...
    public class WaterSFXMod : Mod
    {
        ...
        public override void DoSettingsWindowContents(Rect inRect)
        {
            ...
            listing.CheckboxLabeled("Silence water while music plays", ref Settings.silenceUnderMusic, "When on, water ambience fades to silence while a track is playing, matching the game's own ambient sounds. When off, it only drops to a lower volume.", 0f, 1f);
            listing.End();
        }
